var CACHE = 'fp-reader-4.5';
var ASSETS = ['./', './index.html', './app.js', './parser.js', './ofp.js', './checks.js', './wx.js', './notam-plain.js', './geo.js', './data/dow.json', './data/limits.json', './data/coast.json', './pdfload.js',
